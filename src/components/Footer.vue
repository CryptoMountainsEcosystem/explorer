<template>
  <footer class="max-w-2xl mx-auto px-5 md:px-10 py-8 text-theme-text-tertiary flex flex-col lg:flex-row flex-wrap justify-between items-center">
    <div class="mb-4 lg:mb-0">
      <span class="block md:inline-block mb-4 md:mb-0 text-center">&copy; CryptoMountains | {{ year }}. {{ $t("All rights reserved") }}</span> <div class="block md:inline-block"><span class="hidden md:inline-block"> | </span> <span>{{ $t("Version") }}: <a :href="versionLink" target="_blank">{{ version }}</a> | {{ $t("Date") }}: {{ date }}</span></div>
    </div>
    <div class="text-center">
      <a href="https://www.facebook.com/cmtecosystem" target="_blank">
        <svg
          viewBox="0 0 24 24"
      ...
      <a href="https://twitter.com/CmtEcosystem" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
